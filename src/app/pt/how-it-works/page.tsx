...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/how-it-works/",
    title: "Como funciona — SPay",
    description: "Do registo ao primeiro pagamento em cerca de cinco minutos. Cada passo: criar a conta, carregar com cripto, obter o cartão virtual e começar a gastar.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/pt/how-it-works/"
      footerMarginTop="0"
