...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/about/",
    title: "Sobre nós — SPay",
    description: "A SPay nasceu da ideia de que o dinheiro digital devia ser tão fácil como o dinheiro vivo. Tornamos os pagamentos com stablecoins simples e seguros.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/pt/about/" footerWatermarkLeft="48px">
