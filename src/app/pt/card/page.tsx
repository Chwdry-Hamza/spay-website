...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/card/",
    title: "Cartão — SPay",
    description: "Três cartões Visa virtuais emitidos em minutos: Platinum, Signature e Infinite. Carregue-os a partir do saldo em USDC e pague onde a Visa for aceite.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/pt/card/" footerWatermarkLeft="48px">
