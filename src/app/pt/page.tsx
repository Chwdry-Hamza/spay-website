...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/",
    title: "SPay — Carteira de criptomoedas e cartão Visa em dólares",
    description: "Guarde USDT, USDC, ETH e TRX e gaste-os em qualquer lugar com o cartão Visa da SPay. Uma carteira e um cartão cripto construídos a pensar na conformidade.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/pt/">
      ...
      />
      <HomePage initialContent={content} posts={posts} locale={LOCALE} prefix="/pt" />
