...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/",
    title: "SPay — Kripto cüzdanı ve USD Visa kartı",
    description: "USDT, USDC, ETH ve TRX'i tutun ve SPay Visa kartıyla her yerde harcayın. Uyumluluk odaklı bir kripto cüzdanı ve kartı.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/tr/">
      ...
      />
      <HomePage initialContent={content} posts={posts} locale={LOCALE} prefix="/tr" />
