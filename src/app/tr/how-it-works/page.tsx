...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/how-it-works/",
    title: "Nasıl çalışır — SPay",
    description: "Kayıttan ilk ödemeye kadar yaklaşık beş dakika. Hesap oluşturma, kripto yükleme, sanal kart alma ve harcamanın her adımı.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/tr/how-it-works/"
      footerMarginTop="0"
