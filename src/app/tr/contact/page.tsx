...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/contact/",
    title: "İletişim — SPay",
    description: "Yapay zekâ asistanıyla sohbet edin, bir temsilciye bağlanın ya da ekibe e-posta ve telefonla ulaşın. Kart ve dolandırıcılık konuları önceliklidir.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/tr/contact/"
      footerMarginTop="0"
