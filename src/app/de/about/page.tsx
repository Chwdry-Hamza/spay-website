...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/about/",
    title: "Über uns — SPay",
    description: "SPay entstand aus der Idee, dass digitales Geld so einfach sein sollte wie Bargeld. Wir machen Stablecoin-Zahlungen einfach und sicher für alle.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/de/about/" footerWatermarkLeft="48px">
