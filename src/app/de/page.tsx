...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/",
    title: "SPay — Krypto-Wallet und USD-Visa-Karte",
    description: "Halten Sie USDT, USDC, ETH und TRX und geben Sie sie überall mit der SPay Visa-Karte aus. Eine Krypto-Wallet und Karte, die Compliance an erste Stelle setzt.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/de/">
      ...
      />
      <HomePage initialContent={content} posts={posts} locale={LOCALE} prefix="/de" />
