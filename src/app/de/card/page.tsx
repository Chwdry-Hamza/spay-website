...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/card/",
    title: "Karte — SPay",
    description: "Drei virtuelle Visa-Karten, in Minuten ausgestellt: Platinum, Signature und Infinite. Aus Ihrem USDC-Guthaben aufladen und überall mit Visa bezahlen.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/de/card/" footerWatermarkLeft="48px">
