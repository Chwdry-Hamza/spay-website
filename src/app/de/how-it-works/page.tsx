...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/how-it-works/",
    title: "So funktioniert's — SPay",
    description: "Von der Anmeldung bis zur ersten Zahlung in etwa fünf Minuten. Jeder Schritt: Konto erstellen, Krypto aufladen, virtuelle Karte holen und ausgeben.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/de/how-it-works/"
      footerMarginTop="0"
