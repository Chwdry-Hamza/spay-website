...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/contact/",
    title: "رابطہ کریں — SPay",
    description: "AI اسسٹنٹ سے بات کریں، انسانی ایجنٹ طلب کریں، یا ای میل اور فون پر ٹیم سے رابطہ کریں۔ کارڈ اور فراڈ کے معاملات کو ترجیح دی جاتی ہے۔",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/ur/contact/"
      footerMarginTop="0"
