...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/about/",
    title: "ہمارے بارے میں — SPay",
    description: "SPay اس خیال سے بنا کہ ڈیجیٹل پیسہ نقد کی طرح آسان ہونا چاہیے۔ ہم اسٹیبل کوائن ادائیگیوں کو ہر کسی کے لیے سادہ اور محفوظ بناتے ہیں۔",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/ur/about/" footerWatermarkLeft="48px">
