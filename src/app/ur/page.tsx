...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/",
    title: "SPay — کرپٹو والٹ اور ڈالر والا Visa کارڈ",
    description: "USDT، USDC، ETH اور TRX رکھیں اور SPay کے Visa کارڈ سے کہیں بھی خرچ کریں۔ ریگولیٹری تقاضوں پر بنایا گیا کرپٹو والٹ اور کارڈ۔",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/ur/">
      ...
      />
      <HomePage initialContent={content} posts={posts} locale={LOCALE} prefix="/ur" />
