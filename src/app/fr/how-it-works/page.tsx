...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/how-it-works/",
    title: "Comment ça marche — SPay",
    description: "De l’inscription au premier paiement en cinq minutes environ. Chaque étape : créer le compte, recharger en crypto, obtenir la carte virtuelle et dépenser.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/fr/how-it-works/"
      footerMarginTop="0"
