...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/",
    title: "SPay — Portefeuille crypto et carte Visa en dollars",
    description: "Conservez vos USDT, USDC, ETH et TRX et dépensez-les partout avec la carte Visa SPay. Un portefeuille et une carte crypto pensés pour la conformité.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/fr/">
      ...
      />
      <HomePage initialContent={content} posts={posts} locale={LOCALE} prefix="/fr" />
