...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/about/",
    title: "À propos — SPay",
    description: "SPay est née de l’idée que l’argent numérique devrait être aussi simple que l’espèce. Nous rendons les paiements en stablecoins simples et sûrs.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/fr/about/" footerWatermarkLeft="48px">
