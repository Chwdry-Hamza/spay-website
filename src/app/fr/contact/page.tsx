...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/contact/",
    title: "Contact — SPay",
    description: "Discutez avec l’assistant IA, parlez à un conseiller ou contactez l’équipe par e-mail et téléphone. Les sujets carte et fraude sont prioritaires.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/fr/contact/"
      footerMarginTop="0"
