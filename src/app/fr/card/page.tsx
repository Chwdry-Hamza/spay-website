...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/card/",
    title: "Carte — SPay",
    description: "Trois cartes Visa virtuelles émises en quelques minutes : Platinum, Signature et Infinite. Rechargez-les depuis votre solde en USDC et payez partout où Visa est acceptée.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/fr/card/" footerWatermarkLeft="48px">
