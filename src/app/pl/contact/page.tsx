...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/contact/",
    title: "Kontakt — SPay",
    description: "Napisz do asystenta AI, porozmawiaj z konsultantem albo skontaktuj się z zespołem mailowo i telefonicznie. Sprawy karty i oszustw mają pierwszeństwo.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/pl/contact/"
      footerMarginTop="0"
