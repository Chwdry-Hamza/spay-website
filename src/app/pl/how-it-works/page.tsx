...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/how-it-works/",
    title: "Jak to działa — SPay",
    description: "Od rejestracji do pierwszej płatności w około pięć minut. Każdy krok: załóż konto, zasil krypto, odbierz wirtualną kartę i zacznij płacić.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/pl/how-it-works/"
      footerMarginTop="0"
