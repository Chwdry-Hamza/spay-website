...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/card/",
    title: "Karta — SPay",
    description: "Trzy wirtualne karty Visa wydane w kilka minut: Platinum, Signature i Infinite. Zasilaj je z salda USDC i płać wszędzie tam, gdzie działa Visa.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/pl/card/" footerWatermarkLeft="48px">
