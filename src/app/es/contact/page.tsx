...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/contact/",
    title: "Contacto — SPay",
    description: "Chatea con el asistente de IA, habla con una persona o contacta con el equipo por correo y teléfono. Los casos de tarjeta y fraude tienen prioridad.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/es/contact/"
      footerMarginTop="0"
