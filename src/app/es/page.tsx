...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/",
    title: "SPay — Monedero cripto y tarjeta Visa en dólares",
    description: "Guarda USDT, USDC, ETH y TRX y gástalos donde quieras con la tarjeta Visa de SPay. Un monedero y una tarjeta cripto que ponen el cumplimiento por delante.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/es/">
      ...
      />
      <HomePage initialContent={content} posts={posts} locale={LOCALE} prefix="/es" />
