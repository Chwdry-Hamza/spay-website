...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/how-it-works/",
    title: "كيف تعمل — SPay",
    description: "من التسجيل إلى أول عملية دفع في نحو خمس دقائق. كل خطوة: إنشاء الحساب، والشحن بالعملات الرقمية، والحصول على البطاقة الافتراضية، ثم الإنفاق.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/ar/how-it-works/"
      footerMarginTop="0"
