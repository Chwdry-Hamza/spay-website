...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/card/",
    title: "البطاقة — SPay",
    description: "ثلاث بطاقات Visa افتراضية تصدر خلال دقائق: Platinum وSignature وInfinite. اشحنها من رصيدك بعملة USDC وادفع أينما تُقبل Visa.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/ar/card/" footerWatermarkLeft="48px">
