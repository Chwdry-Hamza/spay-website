...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    locale: LOCALE,
    path: "/contact/",
    title: "تواصل معنا — SPay",
    description: "تحدث مع مساعد الذكاء الاصطناعي، أو مع موظف دعم، أو تواصل مع الفريق بالبريد والهاتف. مسائل البطاقة والاحتيال لها الأولوية.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/ar/contact/"
      footerMarginTop="0"
