...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildLocaleMetadata({
    ...
    path: "/about/",
    title: "من نحن — SPay",
    description: "وُلد SPay من فكرة أن المال الرقمي يجب أن يكون بسهولة النقد. نجعل الدفع بالعملات المستقرة بسيطًا وآمنًا للجميع.",
    page,
    site,
  });
}
...
export default async function Page() {
  ...
  return (
    <SiteShell chrome={chrome} active="/ar/about/" footerWatermarkLeft="48px">
